CREATE OR REPLACE PIPE SDDBMTS1.NMX_MTS1_STG.JDP_ASMNT_SVC_LST_MNTH_SG_PIPE
AUTO_INGEST = TRUE
AS
COPY INTO SDDBMTS1.NMX_MTS1_STG.JDP_ASMNT_SVC_LST_MNTH_SG (
    FSCL_YR_NB,
    FSCL_MNTH_NB,
    SAMPL_ID,
    SRVY_ID,
    ...
    SELECT
        ...
        $56::VARCHAR(1500) AS SQ1A_RSN_WRK_NOT_CMPLTD_1ST_TM_DS,
    ...
    FROM '@NMEX_MAP_EXT_STG/validated/JDP/SERVICIO JDP 1M'
) FILE_FORMAT = (
    TYPE = 'CSV',
    FIELD_DELIMITER = ';',
    SKIP_HEADER = 1,
